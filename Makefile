...
SRC := src/elf64.c src/xdec.c src/arm64.c src/scan.c src/format.c src/strset.c src/cet.c src/category.c src/regidx.c src/recipe.c src/sarif.c src/pivots.c src/main.c
OBJ := $(SRC:.c=.o)
BIN := shrike
